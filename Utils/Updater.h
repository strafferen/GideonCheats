...
public:
    ...
    inline bool UpdateOffsets() {
        ...
        for (const auto& file : Files) {
            ...
            const auto& Engine2 = Data["engine2.dll"];
            ...
            else if (file == "client_dll.json")
            {
                ...
                if (Data.contains("client.dll") && Data["client.dll"].contains("classes")) {
                    ...
                    if (classes.contains("CGameSceneNode")) {
                        ...
                        Offsets::m_bDormant = CGameSceneNode["m_bDormant"];
                    }

                    if (classes.contains("CPlayer_MovementServices_Humanoid"))
                    {
                        auto& CPlayer_MovementServices_Humanoid = classes["CPlayer_MovementServices_Humanoid"]["fields"];
                        Offsets::m_groundNormal = CPlayer_MovementServices_Humanoid["m_groundNormal"];
                    }

                    if (classes.contains("CCSPlayerBase_CameraServices"))
                    {
                        auto& CCSPlayerBase_CameraServices = classes["CCSPlayerBase_CameraServices"]["fields"];
                        Offsets::m_iFOV = CCSPlayerBase_CameraServices["m_iFOV"];
                    }
                }
            }
